                        ...
                        <div class="table-checkable table-highlight-head table-responsive">
                            ...
                            <table v-if="roleUser === 1" role="table" aria-busy="false" aria-colcount="5"
                                ...
                                <tr v-for="item in order" :value="item" role="row" class="">
                                    ...
                                    <td v-else aria-colindex="15" role="cell" class="">Не исправна</td>
                                    <td aria-colindex="16" role="cell" class="">{{ item.created_at }}</td>
                                    <td aria-colindex="17" role="cell" class="">
                                    ...
                                    <td v-if="item.status.name === 'Новая заявка'" aria-colindex="20" role="cell"
                                        class="">
                                        <button class="btn btn-success mb-2 me-1" @click="pushToDefectiveAct(item.id)">
                                            Создать дефектный акт
                                        </button>
                                    </td>
                                    <td v-else aria-colindex="21" role="cell" class="">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table v-if="roleUser === 2" role="table" aria-busy="false" aria-colcount="5"
                                ...
                                <tr role="row" class="">
                                    ...
                                    <th role="columnheader" scope="col" aria-colindex="20" class="text-success">
                                        <div>Действие</div>
                                    </th>
                                </tr>
                                </thead>
                                ...
                                <tr v-for="item in order" :value="item" role="row" class="">
                                    ...
                                    <td aria-colindex="18" role="cell" class="">{{ item.region.region_name }}</td>
                                    <td aria-colindex="19" role="cell" class="">{{ item.contract.signed_at }}</td>
                                    <td aria-colindex="20" role="cell" class="">{{ item.contract.expire_at }}</td>

                                    <td v-if="item.status.name === 'Новая заявка'" aria-colindex="21" role="cell"
                                        class="">
                                        <button class="btn btn-success mb-2 me-1" @click="pushToDefectiveAct(item.id)">
                                            Создать дефектный акт
                                        </button>
                                    </td>
                                    <td v-else aria-colindex="22" role="cell" class="">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
const pushToDefectiveAct = (orderId) => {
